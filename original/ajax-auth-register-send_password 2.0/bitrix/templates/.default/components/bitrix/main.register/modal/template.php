...
<div class="bx-main-register">
	...
	<? else: ?>
		...
		<? endif ?>
		<form method="POST" action="<?= POST_FORM_ACTION_URI ?>" name="regform" class="uk-form uk-form-stacked">
			...
			<input type="hidden" name="backurl" value="" class="backurl">
				...
				<? foreach ($arResult["SHOW_FIELDS"] as $FIELD): ?>
					<? if ($FIELD == "AUTO_TIME_ZONE" && $arResult["TIME_ZONE_ENABLED"] == true): ?>
						<div class="uk-form-row">
							<label class="uk-form-label"><? echo GetMessage("main_profile_time_zones_auto") ?>:<? if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"): ?><span class="asterisk">*</span><? endif ?></label>
					...
					<? else: ?>
						<div class="uk-form-row">
							<label class="uk-form-label"><?= GetMessage("REGISTER_FIELD_".$FIELD) ?>:<? if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"): ?><span	class="asterisk">*</span><? endif ?></label>
							<div class="uk-form-controls">
								<?
								switch ($FIELD)
								{
				...
				<? if ($arResult["USER_PROPERTIES"]["SHOW"] == "Y"): ?>
					...
					<? foreach ($arResult["USER_PROPERTIES"]["DATA"] as $FIELD_NAME => $arUserField): ?>
						<div class="uk-form-row">
							<label class="uk-form-label"><?= $arUserField["EDIT_FORM_LABEL"] ?>:<? if ($arUserField["MANDATORY"] == "Y"): ?><span	class="asterisk">*</span><? endif; ?></>
							<div class="uk-form-controls">
								<? $APPLICATION->IncludeComponent(
