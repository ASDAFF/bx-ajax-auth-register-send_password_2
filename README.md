...
Также, в форме регистрации встроен мой [Антибот регистраций на сайте Битрикс](https://tuning-soft.ru/articles/bitrix/antibot-registration-on-the-website.html), чтобы он заработал, нужно найти в архиве файл init.php.txt в папке /bitrix/php_interface/ и в случае, если на вашем сайте нет такого файла  init.php в той же папке, то просто переименуйте его в init.php, а если есть такой файл, то нужно содержимое файла init.php.txt из архива добавить где-нибудь в конце init.php вашего сайта.

Вот так будут выглядеть формы  

![Форма входа Битрикс в модальном окне](upload/2015-08-22_11.12.37.png "Форма входа Битрикс в модальном окне")

![Форма восстановления пароля Битрикс в модальном окне](upload/2015-08-22_11.14.59.png "Форма восстановления пароля Битрикс в модальном окне")

![Форма регистрации Битрикс в модальном окне](upload/2015-08-22_11.15.10.png "Форма регистрации Битрикс в модальном окне")  
...
![Форма авторизации и регистрации Битрикс на jQuery.ajax(). Часть 2](upload/2015-08-21_21.35.27.png)
...
![Почтовые шаблоны авторизации в Битрикс](upload/2015-08-22_00.05.12.png "Почтовые шаблоны авторизации в Битрикс")
...
![Переменная, которая управляет показом системных полей Логин, пароль, подтверждение пароля в Битрикс](upload/2015-08-22_13.39.26.png "Переменная, которая управляет показом системных полей Логин, пароль, подтверждение пароля в Битрикс")  
...
![](upload/2015-08-22_14.50.42.png)  
...
![Смена капчи аяксом при авторизации и регистрации Битрикс](upload/2015-08-22_14.12.36.png "Смена капчи аяксом при авторизации и регистрации Битрикс")  
...
![Капча при ошибках авторизации в Битрикс](upload/2015-08-22_14.28.57.png "Капча при ошибках авторизации в Битрикс")  
...
![Cортировка полей заданных в настройках компонента регистрации Битрикс](upload/2015-08-22_14.47.53.png "Cортировка полей заданных в настройках компонента регистрации Битрикс")
...
![Модуль Битрикс Социальные сервисы](upload/2015-08-22_17.23.13.png "Модуль Битрикс Социальные сервисы")  

б) В настройках главного модуля **Разрешить авторизацию через внешние сервисы**  
![В настройках главного модуля Разрешить авторизацию через внешние сервисы](upload/2015-08-22_17.27.00.png "В настройках главного модуля Разрешить авторизацию через внешние сервисы")

в) В настройках модуля **Социальные сервисы** включить необходимые и настроить ниже каждый сервис.  
![Настройка модуля Социальные сервисы](upload/2015-08-22_17.28.38.png "Настройка модуля Социальные сервисы")  

После всех настроек в форме авторизации появится **авторизация через социальные сервисы Битрикс**  
![Авторизация через социальные сервисы Битрикс](upload/2015-08-22_17.53.38.png "Авторизация через социальные сервисы Битрикс")
...
![Компонент Form password фреймворка Uikit ](upload/2015-08-22_17.54.36.png "Компонент Form password фреймворка Uikit ")  
...
Скачать шаблон ajax-авторизации и регистрации Битрикс: [ajax-auth-register-send_password 2.0.rar](https://tuning-soft.ru/upload/articles/files/ajax-auth-register-send_password 2.0.rar)  
